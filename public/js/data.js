    ...
    products: [
        {
            ...
            variants: [
                { weight: '25 kg (25 Kg X 1 Qty)', price: 7875, originalPrice: 11250, isMain: true },
        ...
        { id: 2, name: 'Urea Fertilizer 50kg Bag', image: 'https://placehold.co/400x400/66bb6a/ffffff?text=Urea+50kg', category: 'fertilizer', originalPrice: 1200, offerPrice: 999, discount: 17, rating: 4.3, reviewCount: 95, bestSelling: true, description: 'High quality Urea fertilizer for all crops.', images: [], variants: [{ weight: '50 kg', price: 999, originalPrice: 1200, isMain: true }], technicalDetails: {} },
        { id: 3, name: 'DAP Fertilizer 25kg Pack', image: 'https://placehold.co/400x400/81c784/ffffff?text=DAP+25kg', category: 'fertilizer', originalPrice: 1500, offerPrice: 1299, discount: 13, rating: 4.7, reviewCount: 156, bestSelling: false, description: 'DAP Fertilizer for root development.', images: [], variants: [{ weight: '25 kg', price: 1299, originalPrice: 1500, isMain: true }], technicalDetails: {} },
        { id: 4, name: 'Organic Compost 10kg', image: 'https://placehold.co/400x400/a5d6a7/333333?text=Organic+Compost', category: 'fertilizer', originalPrice: 450, offerPrice: 399, discount: 11, rating: 4.2, reviewCount: 67, bestSelling: false, description: 'Rich organic compost.', images: [], variants: [{ weight: '10 kg', price: 399, originalPrice: 450, isMain: true }], technicalDetails: {} },
        { id: 5, name: 'Potash Fertilizer MOP 20kg', image: 'https://placehold.co/400x400/43a047/ffffff?text=Potash+MOP', category: 'fertilizer', originalPrice: 980, offerPrice: 849, discount: 13, rating: 4.4, reviewCount: 89, bestSelling: true, description: 'Potash for fruit quality.', images: [], variants: [{ weight: '20 kg', price: 849, originalPrice: 980, isMain: true }], technicalDetails: {} },
        { id: 6, name: 'Micronutrient Mix 5kg', image: 'https://placehold.co/400x400/388e3c/ffffff?text=Micronutrient', category: 'fertilizer', originalPrice: 650, offerPrice: 549, discount: 16, rating: 4.1, reviewCount: 45, bestSelling: false, description: 'Essential micronutrients mix.', images: [], variants: [{ weight: '5 kg', price: 549, originalPrice: 650, isMain: true }], technicalDetails: {} },
        { id: 7, name: 'Neem Oil Organic Pesticide 1L', image: 'https://placehold.co/400x400/ff9800/ffffff?text=Neem+Oil+1L', category: 'pesticide', originalPrice: 450, offerPrice: 379, discount: 16, rating: 4.6, reviewCount: 234, bestSelling: true, description: 'Organic Neem Oil for pest control.', images: [], variants: [{ weight: '1 L', price: 379, originalPrice: 450, isMain: true }], technicalDetails: {} },
        { id: 8, name: 'Insecticide Spray 500ml', image: 'https://placehold.co/400x400/ffa726/ffffff?text=Insecticide+Spray', category: 'pesticide', originalPrice: 320, offerPrice: 269, discount: 16, rating: 4.3, reviewCount: 112, bestSelling: true, description: 'Effective insecticide spray.', images: [], variants: [{ weight: '500 ml', price: 269, originalPrice: 320, isMain: true }], technicalDetails: {} },
        { id: 9, name: 'Fungicide Powder 250g', image: 'https://placehold.co/400x400/ffb74d/333333?text=Fungicide+250g', category: 'pesticide', originalPrice: 280, offerPrice: 229, discount: 18, rating: 4.4, reviewCount: 78, bestSelling: false, description: 'Fungicide for plant diseases.', images: [], variants: [{ weight: '250 g', price: 229, originalPrice: 280, isMain: true }], technicalDetails: {} },
        { id: 10, name: 'Herbicide Concentrate 1L', image: 'https://placehold.co/400x400/f57c00/ffffff?text=Herbicide+1L', category: 'pesticide', originalPrice: 550, offerPrice: 459, discount: 17, rating: 4.2, reviewCount: 56, bestSelling: false, description: 'Herbicide for weed control.', images: [], variants: [{ weight: '1 L', price: 459, originalPrice: 550, isMain: true }], technicalDetails: {} },
        { id: 11, name: 'Bio Pesticide Organic 500ml', image: 'https://placehold.co/400x400/ef6c00/ffffff?text=Bio+Pesticide', category: 'pesticide', originalPrice: 380, offerPrice: 319, discount: 16, rating: 4.5, reviewCount: 98, bestSelling: true, description: 'Bio-pesticide for safe farming.', images: [], variants: [{ weight: '500 ml', price: 319, originalPrice: 380, isMain: true }], technicalDetails: {} },
        { id: 12, name: 'Rodent Control Pack', image: 'https://placehold.co/400x400/e65100/ffffff?text=Rodent+Control', category: 'pesticide', originalPrice: 220, offerPrice: 189, discount: 14, rating: 4.0, reviewCount: 34, bestSelling: false, description: 'Rodent control solution.', images: [], variants: [{ weight: '1 pack', price: 189, originalPrice: 220, isMain: true }], technicalDetails: {} }
    ]
};
...
function sanitizeDataUrls(data) {
    if (!data) return data;
    
    // Sanitize banner images
    if (data.bannerImage) {
        data.bannerImage = data.bannerImage.replace(/%20\d+$/, '');
    }
    if (data.heroBannerImage) {
        data.heroBannerImage = data.heroBannerImage.replace(/%20\d+$/, '');
    }
    if (data.aboutImage) {
        data.aboutImage = data.aboutImage.replace(/%20\d+$/, '');
    }
    ...
    if (data.products && Array.isArray(data.products)) {
        data.products = data.products.map(product => ({
            ...product,
            image: product.image ? product.image.replace(/%20\d+$/, '') : product.image,
            images: Array.isArray(product.images) ? 
                product.images.map(img => img.replace(/%20\d+$/, '')) : 
                product.images
        }));
    }
...
async function apiRequest(endpoint, method = 'GET', body = null) {
    ...
    if (body) {
        // Protect sensitive info in logs if any remains
        const logBody = { ...body };
